    ...
    getAccordions(lang) {
        const data = {
            ...
            'de': [
                ...
                { title: "6. Aufbewahrungsrichtlinie und Rechte der betroffenen Person", content: `<p><strong>Aufbewahrungszeitraum:</strong> Betriebsdaten werden für die Dauer des Notfalls aufbewahrt. Danach werden sie zu medizinisch-rechtlichen Zwecken für den gesetzlich vorgeschriebenen Zeitraum archiviert (z.B. 10 Jahre für die ärztliche Haftung) oder für statistische und Forschungszwecke irreversibel anonymisiert.</p><p><strong>Ausübung von Rechten:</strong> Sie können jederzeit das Recht auf Auskunft, Berichtigung, Löschung ("Recht auf Vergessenwerden"), Einschränkung, Übertragbarkeit und Widerspruch ausüben. Sie können Ihre Einwilligung über die App-Einstellungen widerrufen, was zur Löschung lokaler und entfernter Daten führt. Für Beschwerden können Sie sich an die nationale Datenschutzbehörde wenden.</p>` }
            ],
        };
